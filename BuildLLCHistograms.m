function [ H_all ] = BuildLLCHistograms( imageFileList, dataBaseDir, featureSuffix, dictionarySize, canSkip, K )
...
%        texton_ind.data = min_ind;
        ...
        for j = 1:batchSize:ndata
            ...
            texton_ind.data(lo:hi,:) = LLC(features.data(lo:hi,:), dictionary, K);
